...
@endforeach
    ...
    <div class="row">
        ...
        <div class="col-md-6 mt-2">
            <label>Phone</label>
            <input type="text" class="form-control" name="phone" id="phone" pattern="\d{10}" title="Enter 10 digit phone number">
        </div>
        ...
        <div class="col-md-6 mt-2">
            ...
            <input type="file" class="form-control" name="additional_file" id="additional_file" accept=".pdf,.doc,.docx,.xls,.xlsx">
        </div>
    </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                @elseif($field->type === 'textarea')
                    <textarea class="form-control custom-field"
                        name="custom_fields[{{ $field->id }}]" data-field-id="{{ $field->id }}"></textarea>
...
<script>
    ...
    <script>
        ...
        $('.editBtn').on('click', function() {
            ...
            $.get("{{ url('/contacts/custom-fields') }}/" + $(this).data('id'), function(res) {
                res.forEach(item => {
                    $(`[name="custom_fields[${item.custom_field_id}]"]`).val(item.field_value);
                });
            });
